...
export const dictionary: Record<Lang, Dictionary> = {
  id: {
    ...
    testimonials: {
      eyebrow: "TESTIMONI",
      title: "Apa kata mitra kerja kami",
      sub: "Contoh gambaran umpan balik dari jenis engagement yang biasa kami jalankan.",
      disclaimer: "Konten ilustratif — belum berasal dari klien terverifikasi. Akan diganti dengan testimoni asli begitu tersedia.",
      items: [
        {
          quote: "Timnya cepat memahami kondisi lapangan kami dan tidak memberikan rekomendasi generik. Pendekatannya terasa dikerjakan bersama tim internal, bukan sekadar laporan dari luar.",
          role: "Direktur Operasional",
          sector: "Distribusi & Trading",
        },
        {
          quote: "Yang paling membantu adalah semua deliverable-nya bisa langsung kami pakai dan edit sendiri — bukan dokumen tertutup yang hanya bisa dibaca.",
          role: "Head of Supply Chain",
          sector: "Manufaktur",
        },
        {
          quote: "Prosesnya terstruktur dari awal diagnostik sampai pilot, dan kami dilibatkan penuh di setiap tahap keputusan.",
          role: "VP Commercial",
  ...
  en: {
    ...
    testimonials: {
      ...
      title: "What our engagement partners say",
      sub: "Illustrative examples of the kind of feedback we typically receive.",
      disclaimer: "Illustrative content — not yet sourced from a verified client. Will be replaced with real testimonials once available.",
      items: [
        {
          quote: "The team quickly understood our situation on the ground and didn't give us generic recommendations. It felt like working with an internal team, not just receiving a report from outside.",
          role: "Operations Director",
          sector: "Distribution & Trading",
        },
        {
          quote: "What helped most was that every deliverable was something we could actually use and edit ourselves — not a closed document we could only read.",
          role: "Head of Supply Chain",
          sector: "Manufacturing",
        },
        {
          quote: "The process was structured from diagnostic through pilot, and we were fully involved at every decision point.",
          role: "VP Commercial",
